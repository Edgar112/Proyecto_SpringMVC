                ...
                <div class="card border-black" style="border-radius: 1rem;">
                    <div class="row g-0">
                        <div class="card-body p-4 p-lg-5 text-black" >
                            <h3 class="text-center py-3">¡Editar Contrato!</h3>
                            ...
                            <form:form name= "" method="post" modelAttribute="contrato">
                                ...
                                <div class="form-outline mb-4">
                                    ...
                                    <input type="date" name="fechainicio" value="${contrato.fechainicio}" class="form-control form-control-lg" required />
                                </div>

                                <div class="form-outline mb-4">
                                    <label>MONTO DE CREDITO: </label>
                                    <input type="number" name="montocredito" value="${contrato.montocredito}" class="form-control form-control-lg" required />
                                </div>
								...
								<div class="text-center justify-content-between">
                                    <button type="submit" onclick="alert('Se edito correctamente')" class="btn btn-primary">Guardar</button>
